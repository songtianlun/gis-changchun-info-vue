    ...
    export default {
      ...
      methods: {
        initmap: function () {
          ...
          let TianLunMap = L.tileLayer.wms(
            'http://114.116.67.239:8090/iserver/services/map-Basic2Map/wms130',
            {
              layers: 'trackmap_daytime',
              attribution: 'Haut-Gis-Org © 2019 TianLunMap'
            }
          )
          let ChangChun = L.tileLayer.wms(
            'http://114.116.67.239:8090/iserver/services/map-changchun/wms130',
            {
              layers: '长春市区图',
              attribution: 'Haut-Gis-Org © SuperMap iServer'
            }
          )
